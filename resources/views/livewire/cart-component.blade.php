        ...
        <div class=" main-content-area">
                    ...
                    <div class="order-summary">
                        ...
                        @if (Session::has('coupon'))
                            <p class="summary-info">
                                <span class="title">
                                    Descuento ({{ Session::get('coupon')['code'] }})
                    ...
                    @if (Session::has('coupon'))
                        <div class="checkout-info">
                            <label class="checkbox-field">
                                ...
                                <span>Yo Tengo en Cupon de Descuento</span>
                            </label>
                            @if ($haveCouponCode == 1)
                                <div class="summary-item">
                                    <form wire:submit.prevent="applyCouponCode">
                                        <h4 class="title-box">Código Cupon</h4>
                                        ...
                                        @endif
                                        <p class="row-in-form">
                                            <label for="coupon-code">Ingrese su Código de Cupon:</label>
                            ...
                            <a class="link-to-shop" href="{{ route('/shop') }}">Continuar Comprando
            ...
            @else
                <div class="text-center" style="padding: 30px 0;">
                    <h4>Su Carro de Compras Esta Vació</h4>
                    <p>Agregar Items Ahora</p>
                    <a href="/shop" class="btn btn-success">Ir a Tienda</a>
                </div>
            @endif
