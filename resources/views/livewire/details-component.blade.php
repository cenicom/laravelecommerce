    ...
    <div class="container">
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>Detalles del Producto</span></li>
            </ul>
        </div>
        <div class="row">
                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        @if ($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                            <div class="wrap-price">
                                ...
                                <del>
                                    <span class="product-price reg-price">${{ $product->regular_price }}</span>
                                </del>
                            </div>
                        @else
                            <div class="wrap-price">
                        ...
                        <div class="stock-info in-stock">
                            <p class="availability">Diponibilidad: <b>{{ $product->stock_status }}</b></p>
                        </div>
                        <div class="quantity">
                            <span>Quantity:</span>
                    ...
                    <div class="advance-info">
                        <div class="tab-control normal">
                            ...
                            <a href="#add_infomation" class="tab-control-item">Inforación Adicional</a>
